...
2. we do not want to contribute to the [techno-authoritarian stack](https://www.authoritarian-stack.info/) that is developing in the United States. We disapprove of Microsoft's involvement in the [use of AI/Azure by the Israeli](https://www.972mag.com/microsoft-azure-openai-israeli-army-cloud/) and American armies, and we wish to maintain sovereignty over our IT stack.
